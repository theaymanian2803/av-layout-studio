...
const Index = () => {
  ...
  return <main className="overflow-hidden bg-background">
    ...
    <section className="container mx-auto px-4 pb-14"><div className="mb-7 text-center"><h2 className="text-2xl font-extrabold text-primary">The PetPaw Journal</h2><p className="mt-1 text-sm text-muted-foreground">Simple guidance for better everyday care.</p></div><div className="grid gap-5 md:grid-cols-3">{[
      ["https://images.unsplash.com/photo-1558788353-f76d92427f16?auto=format&fit=crop&w=900&q=80","How to make mealtimes healthier for your dog","Nutrition"],
      ["https://images.unsplash.com/photo-1518791841217-8f162f1e1131?auto=format&fit=crop&w=900&q=80","A calmer routine for happy indoor cats","Wellbeing"],
